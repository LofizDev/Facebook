        ...
        <div className={classes.rightbarContainer}>
            ...
            <div className={classes.listAdsBox}>
                <div className={classes.adsBox}>
                    <img className={classes.imgAds} src="https://scontent.fsgn2-3.fna.fbcdn.net/v/t45.1600-4/cp0/q90/spS444/p296x100/152919644_23846625554540328_1720143279169095301_n.png.jpg?_nc_cat=106&ccb=1-5&_nc_sid=67cdda&_nc_ohc=AM7WAYQEx4oAX-x0GLf&_nc_ht=scontent.fsgn2-3.fna&oh=fcdc7fc670bcbff18995d20c85349ba7&oe=617FEA04" alt="adsbox" />
