            ...
            <div className={classes.composerTop}>
                ...
                <div className={classes.typeCreate}>
                    <div className={classes.typeCreateButton}>
                        ...
                        <span className={classes.textType}>Video trực tiếp</span>
                    </div>
                    <div className={classes.typeCreateButton}>
                        ...
                        <span className={classes.textType}>Ảnh/Video</span>
                    </div>
                    <div className={classes.typeCreateButton} >
                        <span className={classes.iconType} style={{ position: 'relative' }}>
                            <i className={classes.eventIcon}></i>
                        </span>
                        <span style={{paddingLeft:'20px'}} className={classes.textType}>Sự kiện trong đời</span>
                    </div>
                </div>
