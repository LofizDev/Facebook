        ...
        <div className={classes.container}>
          ...
          <div className={classes.headerRight}>
            <ul className={classes.listIconsRight}>
              ...
              <li className={classes.iconItemRight}>
                <i className={classes.iconMenu}></i>
              </li>
              </BlueOnGreenTooltip>
              ...
              <li onClick={() => setShowSetting(!showSetting)} className={classes.iconItemRight}>
                <div className={classes.iconItemRightDropdown}></div>
              </li>
            </ul>
          </div>
        </div>
